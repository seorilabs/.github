...
> 상태: P0 기준선과 P1·P4·P5·P6 Backoffice 제어면 배포, P2 broker·P3 pilot 검증 중. P7 장치는 2026-09-12에 제거했다
...
P7 이관 전 인벤토리 장치(collector, 권위 inventory issuer, 증적 원장, cleanup executor)는
2026-09-12에 제거했다. 인벤토리는 발급까지 끝나 결과물을 얻었고, 남은 장치가 15분 창과
수동 정렬 같은 수작업을 요구해 목적과 어긋났다.

저장소별 legacy 운영 JSON 정리는 남아 있는 실제 작업이지만, 서명된 계약 체계 없이
평범한 PR로 진행한다.
